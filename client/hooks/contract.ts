...
export const CONTRACT_ADDRESS =
  "CDDTZRMQVQXHBYHFHLBQ6FTMIDNTHE6LC2XPZWGN654JTBIHCIHORKVW";
...
// ============================================================
// Loyalty Points — Contract Methods
// ============================================================

/**
 * Earn points for an action.
 * Actions: "purchase" (100), "referral" (200), "review" (50), or any other (10)
 */
export async function earn(
  ...
  return callContract(
    "earn",
    [toScValAddress(caller), toScValString(action)],
    caller,
    true
  );
}
...
export async function transfer(
  ...
  return callContract(
    "transfer",
    [toScValAddress(caller), toScValAddress(to), toScValU32(amount)],
    caller,
    true
  );
}
...
/**
 * Redeem points (burn them for rewards).
 */
export async function redeem(
  ...
  return callContract(
    "redeem",
    [toScValAddress(caller), toScValU32(amount)],
    caller,
    true
  );
}
 ...
 */
export async function balance(user: string, caller?: string) {
  return readContract("balance", [toScValAddress(user)], caller);
}

/**
 * Get lifetime points earned.
 */
export async function totalEarned(user: string, caller?: string) {
  return readContract("total_earned", [toScValAddress(user)], caller);
}

/**
 * Get lifetime points redeemed.
 */
export async function totalRedeemed(user: string, caller?: string) {
  return readContract("total_redeemed", [toScValAddress(user)], caller);
}
